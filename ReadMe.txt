========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : E_140
========================================================================


AppWizard has created this E_140 application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your E_140 application.
...
res\E_140.ico
    ...
    icon is included by the main resource file E_140.rc.
...
E_140Dlg.h, E_140Dlg.cpp - the dialog
    These files contain your CE_140Dlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in E_140.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CE_140DlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named E_140.pch and a precompiled types file named StdAfx.obj.
